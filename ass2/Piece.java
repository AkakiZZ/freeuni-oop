...
public class Piece {
	...
	*/
	...
	public Piece computeNextRotation() {
		...
		for (int i = 0; i < body.length; i++) {
			rotatedBody[i] = new TPoint(-body[i].y + height - 1, body[i].x);
		}
	...
	*/
	public boolean equals(Object obj) {
		...
		TPoint[] arr1 = other.getBody();
		TPoint[] arr2 = this.getBody();
		Arrays.sort(arr1);
		Arrays.sort(arr2);
	...
	*/
	private static Piece makeFastRotations(Piece root) {
		...
		while (!root.equals(rotated)) {
			current.next = rotated;
			current = rotated;
			rotated = current.computeNextRotation();
		}
		current.next = root;
	...
	*/
	...
	/**
	 * Sets width and height of a piece with the body array
	 */
	...
	/**
	 * Sets skirt of piece a with the body array
	 */
